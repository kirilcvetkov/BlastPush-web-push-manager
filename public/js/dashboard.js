...
/***/ "./resources/js/Purple/dashboard.js":
/*!******************************************!*\
  !*** ./resources/js/Purple/dashboard.js ***!
  \******************************************/
/*! no static exports found */
...
/* WEBPACK VAR INJECTION */(function(jQuery) {(function ($) {
  ...
  $(function () {
    ...
    if ($('#subscribers-chart').length) {
      var chartSubs = new Chart($('#subscribers-chart'), {
        type: 'line',
        responsive: true,
        data: {
          labels: [],
    ...
    if ($('#unsubscribers-chart').length) {
      var chartUnsubs = new Chart($('#unsubscribers-chart'), {
        type: 'line',
        responsive: true,
        data: {
          labels: [],
    ...
    if ($('#push-chart').length) {
      var chartPush = new Chart($('#push-chart'), {
        type: 'line',
        responsive: true,
        data: {
          labels: [],
    ...
    if ($('#clicks-chart').length) {
      var chartClicks = new Chart($('#clicks-chart'), {
        type: 'line',
        responsive: true,
        data: {
          labels: [],
    ...
    if ($('#events-chart').length) {
      ...
      var colors = createColors(ctx);
      var legend = createColors(ctx, true);
      ...
      $.get('/dashboard/events', function (response) {
        ...
        trafficChart.data.datasets.forEach(function (dataset, index) {
    ...
    if ($('#subscriptions-chart').length) {
      ...
      var doughnutOptions = {
        ...
        legendCallback: function legendCallback(chart) {
          ...
          for (var i = 0; i < chart.data.datasets[0].data.length; i++) {
            text.push('<li><span class="legend-dots" style="background:' + chart.data.datasets[0].legendColor[i] + '"></span>');

            if (chart.data.labels[i]) {
              text.push('<span class="h5">' + chart.data.labels[i] + '</span>');
            }

            text.push('<span class="float-right h5 pr-3">' + chart.totals[i] + '% | ' + chart.data.datasets[0].data[i] + '</span>');
            text.push('</li>');
          }
      ...
      $.get('/dashboard/subscriptions', function (response) {
        subsChart.data.datasets.forEach(function (dataset) {
  ...
  function createColors(ctx) {
    var legendColors = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : false;
    ...
    if (legendColors) {
      return [gradientLegendGreen, gradientLegendRed, gradientLegendBlue, gradientLegendPurple, gradientLegendViolet, gradientLegend1, gradientLegend2];
    }

    return [gradientStrokeGreen, gradientStrokeRed, gradientStrokeBlue, gradientStrokePurple, gradientStrokeViolet, gradientStroke1, gradientStroke2];
  }
})(jQuery);
...
/***/ 2:
/*!************************************************!*\
  !*** multi ./resources/js/Purple/dashboard.js ***!
  \************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

module.exports = __webpack_require__(/*! /Users/kirilcvetkov/www/inertia/resources/js/Purple/dashboard.js */"./resources/js/Purple/dashboard.js");
