...
(function (mod) {
  if (( false ? undefined : _typeof(exports)) == "object" && ( false ? undefined : _typeof(module)) == "object") // CommonJS
    mod(__webpack_require__(!(function webpackMissingModule() { var e = new Error("Cannot find module '../../lib/codemirror'"); e.code = 'MODULE_NOT_FOUND'; throw e; }())));else if (true) // AMD
    !(__WEBPACK_AMD_DEFINE_ARRAY__ = [!(function webpackMissingModule() { var e = new Error("Cannot find module '../../lib/codemirror'"); e.code = 'MODULE_NOT_FOUND'; throw e; }())], __WEBPACK_AMD_DEFINE_FACTORY__ = (mod),
...
/***/ 7:
/*!*********************************************!*\
  !*** multi ./resources/js/Purple/simple.js ***!
  \*********************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

module.exports = __webpack_require__(/*! /Users/kirilcvetkov/www/inertia/resources/js/Purple/simple.js */"./resources/js/Purple/simple.js");
